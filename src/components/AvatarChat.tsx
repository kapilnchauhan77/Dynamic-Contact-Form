...
function AvatarChat () {
  ...
  const handleEmailSubmission = () => {
      postToAPI("generateInfo/", {"email": email,"insights_KPIs": [...insightsKPI, { "question": question, "answer": answer }]}).then(() => {
              setQuestion("Please find the link to your survey in mail!")
              setShowMail(false)
          })
      }
