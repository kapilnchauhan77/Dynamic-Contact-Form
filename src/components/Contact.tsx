...
export default function Contact() {
  ...
  <div className='bg-slate-200'>
      <div className="mx-auto max-w-2xl text-center p-3">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"><u>Please provide additional data</u></h2>
        <h3 className="text-2xl font-bold text-red-600 sm:text-2xl">Looking for something specific?</h3>
        <p className="text-lg font-bold leading-8">If you're in need of a tailored search within your content or a custom solution to match your unique requirements, we're here to help!</p>
      </div>
